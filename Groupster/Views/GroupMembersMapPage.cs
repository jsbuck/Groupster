...
{
	public class GroupMembersMapPage : ContentPage
	{
		private readonly GroupMembersMapViewModel _viewModel;

		public GroupMembersMapPage (GeoLocation location)
		{
			//Todo : inject the service
			_viewModel = new GroupMembersMapViewModel (new GooglePlacesService (new HttpClient ()), location);
